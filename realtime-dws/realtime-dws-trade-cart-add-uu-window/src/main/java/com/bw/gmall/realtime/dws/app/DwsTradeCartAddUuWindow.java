...
public class DwsTradeCartAddUuWindow extends BaseApp {
    public static void main(String[] args) {
        new DwsTradeCartAddUuWindow().start(Constant.TOPIC_DWD_TRADE_CART_ADD,"1",1,10009);
    }
    @Override
...
//                                System.err.println(bean + "==================================>");
               ...
               map.print("111111=====================>");
        map.sinkTo(FlinkSinkUtil.getDorisSink("ch_gmall_env.dws_trade_cart_add_uu_window"));
    }
}
