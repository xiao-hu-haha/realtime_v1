...
public class  Constant {
    ...
    public static final String DorisNmae = "admin";
    public static final String DorisPass = "zh1028,./";

    public static final String DORIS_DATABASE = "ch_gmall_env";
    ...
    public static final String DWS_TRADE_CART_ADD_UU_WINDOW = "ch_gmall_env.dws_trade_cart_add_uu_window";
